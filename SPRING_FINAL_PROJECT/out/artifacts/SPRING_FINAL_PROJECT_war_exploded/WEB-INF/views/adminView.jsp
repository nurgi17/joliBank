...
<div class="page-container">
    ...
    <div class="page-sidebar">
        ...
        <ul class="x-navigation">
            ...
            <li class="active">
                <a href="#"><span class="fa fa-money"></span> <span class="xn-text">View total balance</span></a>
            </li>
        </ul>
        <!-- END X-NAVIGATION -->
    </div>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <table class="table">
                                ...
                                <tbody>
                                <c:if test="${allBalance!=null}">
                                    <c:forEach items="${allBalance}" var="bal">
                                <tr>
                                    <td>${bal.id}</td>
                                    <td>${bal.currency_id.id}</td>
                                    <td>${bal.currency_id.name}</td>
                                    <td>${bal.currency_id.short_name}</td>
                                    <td>${bal.value}</td>
                                </tr>
                                    </c:forEach>
                                </c:if>
